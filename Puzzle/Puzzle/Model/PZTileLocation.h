...
static inline bool PZTileLocationInSameColumnAsLocation(PZTileLocation loc1, PZTileLocation loc2)
{
    return loc1.x == loc2.x;
}

static inline bool PZTileLocationInSameRowAsLocation(PZTileLocation loc1, PZTileLocation loc2)
{
